...
export default function AboutPage(){
   return (
         <div>
            <h1 className="mt-2 text-lg leading-8 text-white-600 px-10 py-3 rounded-xl shadow-lg">
              저희 학교를 소개합니다.
            </h1>
            <div className="mt-6 text-lg leading-8 text-white-600 px-10 py-10 rounded-xl shadow-lg"> 
